...
**詳細な規約:**
- `.Codex/rules/backend/` - レイヤー構造、DTO、テスト、コーディング規約の詳細
...
📖 **詳細**: `.Codex/rules/backend/02-layers.md`
...
- **`.Codex/rules/backend/01-overview.md`** - アーキテクチャ全体像
- **`.Codex/rules/backend/02-layers.md`** - 各レイヤーの詳細責務とコード例
- **`.Codex/rules/backend/03-dto-data.md`** - Laravel Data による DTO 実装
- **`.Codex/rules/backend/04-typescript-generation.md`** - TypeScript 型生成
- **`.Codex/rules/backend/05-inertia-backend.md`** - Inertia.js バックエンド実装
- **`.Codex/rules/backend/06-testing.md`** - テスト戦略
- **`.Codex/rules/backend/07-best-practices.md`** - ベストプラクティス
- **`.Codex/rules/backend/08-coding-standards.md`** - コーディング規約
