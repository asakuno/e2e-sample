...
final class FetchDailyStockPriceJob implements ShouldBeUnique, ShouldQueue
{
    use Queueable;
    ...
    public function handle(FetchDailyStockPriceUseCase $useCase): void
    {
    ...
    {
        Log::error('Daily stock price fetch failed.', [
