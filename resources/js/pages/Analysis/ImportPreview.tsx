...
const AnalysisImportPreview: InertiaPageComponent<AnalysisImportPreviewPageProps> = ({
  batch,
  analysisImport,
}) => {
    ...
    <>
      ...
      <div className="flex flex-col gap-6">
        ...
        <header className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
          ...
          <StatusBadge
            variant={
              validated ? 'positive' : analysisImport.status === 3 || stale ? 'warning' : 'neutral'
            }
          >
...
AnalysisImportPreview.layout = withAuthenticatedLayout;

export default AnalysisImportPreview;
