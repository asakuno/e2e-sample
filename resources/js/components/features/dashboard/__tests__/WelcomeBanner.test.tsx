...
describe('WelcomeBanner', () => {
  ...
  it('最新分析日時が指定された場合に表示すること', () => {
    const latestAnalysisAt = '2026-06-15T11:00:00+00:00';

    render(<WelcomeBanner userName="田中太郎" latestAnalysisAt={latestAnalysisAt} />);

    expect(screen.getByText('2026/06/15 20:00')).toHaveAttribute('datetime', latestAnalysisAt);
  });
